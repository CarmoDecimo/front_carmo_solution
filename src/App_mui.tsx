...
// Mesma largura definida no Sidebar.tsx
  ...
  return (
    <Box sx={{ display: 'flex', minHeight: '100vh', bgcolor: 'grey.100' }}>
      ...
      >
        ...
        <Box
          sx={{
            pt: 10, // Espaço para o header fixo
            pb: 3,
            px: { xs: 2, sm: 3, md: 4 },
          }}
        >
            ...
            >
              <Routes>
                ...
                <Route path="/auth" element={
                  <Box>
                    <h2 className="text-2xl font-semibold mb-4">Login/Cadastro</h2>
                    <p className="text-gray-600">Sistema de autenticação</p>
                  </Box>
                } />
